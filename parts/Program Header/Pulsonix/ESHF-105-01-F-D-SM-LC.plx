...
(library Library_1
	...
	(patternDef "ESHF10501FDSMLC" (originalName "ESHF10501FDSMLC")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0.000, -0.280) (textStyleRef "Normal") (isVisible True))
		)
	...
	(compDef "ESHF-105-01-F-D-SM-LC" (originalName "ESHF-105-01-F-D-SM-LC") (compHeader (numPins 10) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "http://suddendocs.samtec.com/prints/eshf-1xx-01-x-d-xx-xx-mkt.pdf")
		(attr "<Component Height>" "5.33")
		(attr "<STEP Filename>" "ESHF-105-01-F-D-SM-LC.stp")
